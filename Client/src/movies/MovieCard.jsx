  ...
  return (
    <section className="py-4">
      ...
      <div className="relative w-full min-h-[90vh] text-white bg-gray-900 overflow-hidden">
        ...
        <button
          onClick={() => navigate(-1)}
          className="text-red-600 py-2 rounded fixed z-10 right-4 top-4 sm:right-6 sm:top-30 hover:text-blue-600"
        >
            ...
            <div className="flex flex-col md:flex-row gap-4 md:gap-10 items-center justify-center md:justify-start">
              ...
              <div className="flex gap-4">
                ...
                <button
                  ...
                  title={isInWishlist(movie.id, "movie") ? "Remove from wishlist" : "Add to wishlist"}
                >
                  <FontAwesomeIcon
                    icon={faHeart}
                    className={

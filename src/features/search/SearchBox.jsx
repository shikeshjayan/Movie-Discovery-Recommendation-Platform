        ...
        <div className="search-box relative flex flex-col items-center w-full max-w-md z-50">
            <form className="w-full relative">
                <input style={{ paddingInline: "2.5rem" }}
                    ...
                    className="w-full h-10 px-4 pl-10 border border-blue-100 rounded bg-transparent text-black focus:outline-none focus:ring-1 focus:ring-blue-500 placeholder-gray-400 text-sm"
                />
